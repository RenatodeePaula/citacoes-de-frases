...
function randomPrases() {  
    const randomPrases = Math.random() * quotes.length  
    const index = Math.floor(randomPrases)
    phrase.textContent = quotes[index].quote
    author.textContent = quotes[index].author
}

btn.addEventListener('click', randomPrases)